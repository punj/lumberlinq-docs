# Products and Loading Sites FAQ
...
Product name, formula, and HS code are required. Species, product code, description, and photos are optional.
...
Deletion can fail when the product is already used by containers, tally sheets, measurements, bills of lading, or other linked records.
...
The list page supports global search and table filtering for the main loading site fields shown on the table.
